      ...
      >
        <div>
          {index === 0 && showCheckbox ? (
            ...
            <>
              <div className="relative  whitespace-nowrap justify-between uppercase w-full items-center px-6 text-start text-black text-sm not-italic font-normal flex pt-[14px] pb-[25px]">
                <div className="flex">
                  {label}
